      ...
      <div class="panel-body">
          ...
          <div class="table-responsive">
            ...
            <div class="modal fade " id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              ...
              <!-- Art Print -->
              <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#tshirt">
                  Launch demo modal
              </button>
              <!-- Modal -->
              <div class="modal fade " id="tshirt" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                  <div class="modal-dialog" role="document">
                      <div class="modal-content">
                          <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
...
background-repeat:no-repeat;background-size:300px; " id="tshirt_wrap">
                                              <img src="<?php echo $creation_url_full;?>" width="<?php echo $tshirt['srcWidth'];?>" height="<?php echo $tshirt['srcHeight'];?>"
