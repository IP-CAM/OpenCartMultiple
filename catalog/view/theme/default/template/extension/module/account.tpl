<div class="list-group">
  ...
  <?php if ($logged) { ?>
  <a href="<?php echo $follow_theme; ?>" class="list-group-item"><?php echo $text_follow_theme; ?></a>
  <a href="<?php echo $follow_artist; ?>" class="list-group-item"><?php echo $text_follow_artist; ?></a>
